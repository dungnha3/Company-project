...
public interface FileRepository extends JpaRepository<File, Long> {
        ...
        // [SAAS] Tính tổng dung lượng sử dụng của công ty
        @Query("SELECT SUM(f.fileSize) FROM File f WHERE f.company.companyId = :companyId AND f.isDeleted = false")
        Long sumFileSizeByCompany(@Param("companyId") Long companyId);
}
