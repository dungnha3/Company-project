...
public interface SalaryRepository extends JpaRepository<Salary, Long> {
        ...
        BigDecimal getTotalNetSalaryByEmployeeAndYear(@Param("employeeId") Long employeeId,
        ...
        @Query("SELECT s FROM Salary s WHERE s.company.companyId = :companyId")
        org.springframework.data.domain.Page<Salary> findByCompanyId(@Param("companyId") Long companyId,
                        org.springframework.data.domain.Pageable pageable);

        org.springframework.data.domain.Page<Salary> findByEmployee_EmployeeId(Long employeeId,
                        org.springframework.data.domain.Pageable pageable);

        org.springframework.data.domain.Page<Salary> findByMonthAndYear(Integer month, Integer year,
                        org.springframework.data.domain.Pageable pageable);
