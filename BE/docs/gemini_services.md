...
> **Updated: 2026-02-09** - Added System Admin, Integration, Personal Tasks, Gantt, Custom Fields APIs
...
## 15. System Admin APIs

### SysAdminCompanyController (`/api/sysadmin/companies`)

| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/` | List all companies | SYSTEM_ADMIN |
| GET | `/{companyId}` | Get company details | SYSTEM_ADMIN |
| GET | `/{companyId}/settings` | Get company settings | SYSTEM_ADMIN |
| PUT | `/{companyId}` | Update company info | SYSTEM_ADMIN |
| PUT | `/{companyId}/plan` | Change subscription plan | SYSTEM_ADMIN |
| PUT | `/{companyId}/status` | Toggle active/suspended | SYSTEM_ADMIN |
| DELETE | `/{companyId}` | Delete company | SYSTEM_ADMIN |
| PUT | `/{companyId}/quota` | Update quotas | SYSTEM_ADMIN |
| PUT | `/{companyId}/features` | Override features | SYSTEM_ADMIN |
| PUT | `/{companyId}/settings` | Update settings | SYSTEM_ADMIN |

### SysAdminUserController (`/api/sysadmin/users`)

| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/` | List all users | SYSTEM_ADMIN |
| GET | `/{userId}` | Get user details | SYSTEM_ADMIN |
| PUT | `/{userId}/system-admin` | Toggle system admin | SYSTEM_ADMIN |
| PUT | `/{userId}/status` | Toggle user status | SYSTEM_ADMIN |

### SysAdminAnalyticsController (`/api/sysadmin/analytics`)

| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/stats` | System-wide statistics | SYSTEM_ADMIN |
| GET | `/growth` | Growth metrics | SYSTEM_ADMIN |
...
| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/available` | List available integrations | Required |
| GET | `/` | List connected integrations | Required |
| POST | `/connect` | Connect integration | ADMIN, MANAGER |
| PUT | `/{integrationId}` | Update integration config | ADMIN, MANAGER |
| DELETE | `/{integrationId}` | Disconnect integration | ADMIN |
| POST | `/{integrationId}/test` | Test connection | ADMIN, MANAGER |

---

## 17. Personal Tasks APIs

### PersonalTaskController (`/api/me/tasks`)

| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/` | List personal tasks | Required |
| GET | `/stats` | Get task stats & quota | Required |
| POST | `/` | Create task (quota check) | Required |
| PUT | `/{id}` | Update task | Owner |
| DELETE | `/{id}` | Delete task | Owner |

> **Note**: FREE plan = 10 tasks max. PRO = Unlimited + Labels + Recurring
...
| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/projects/{projectId}/gantt` | Get Gantt chart data | Member |
| PUT | `/issues/{issueId}/gantt` | Update issue dates (drag-drop) | Member |
| POST | `/issues/dependencies` | Create dependency | Member |
| GET | `/issues/{issueId}/dependencies` | Get issue dependencies | Member |
| DELETE | `/dependencies/{dependencyId}` | Delete dependency | Member |

### CustomFieldController (`/api`)

| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/projects/{projectId}/custom-fields` | Get project custom fields | Member |
| POST | `/projects/{projectId}/custom-fields` | Create custom field | Project Admin |
| PUT | `/custom-fields/{fieldId}` | Update custom field | Project Admin |
| DELETE | `/custom-fields/{fieldId}` | Delete custom field | Project Admin |
| POST | `/projects/{projectId}/custom-fields/reorder` | Reorder fields | Project Admin |
| GET | `/issues/{issueId}/custom-fields` | Get issue field values | Member |
| PUT | `/issues/{issueId}/custom-fields` | Set field values | Member |
