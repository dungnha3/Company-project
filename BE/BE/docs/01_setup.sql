...
BEGIN
    ...
    INSERT INTO [dbo].[companies] (company_id, name, slug, subscription_plan, is_active, created_at)
...
BEGIN
    ...
    INSERT INTO [dbo].[users] (username, password_hash, email, is_active, is_deleted, is_online, is_system_admin, [status], avatar_data, created_at) VALUES
...
BEGIN
    -- Core users
    INSERT INTO [dbo].[company_members] (user_id, company_id, is_active, joined_at, permissions) VALUES
        (@admin_id, 1, 1, GETDATE(), '{}'),
        (@hr_id, 1, 1, GETDATE(), '{}'),
        (@acc_id, 1, 1, GETDATE(), '{}'),
        (@pm_id, 1, 1, GETDATE(), '{}'),
        (@emp_id, 1, 1, GETDATE(), '{}');
    ...
    -- 5 Admins
    INSERT INTO [dbo].[company_members] (user_id, company_id, is_active, joined_at, permissions)
    SELECT user_id, 1, 1, GETDATE(), '{}' FROM [dbo].[users] WHERE username LIKE 'admin[1-5]';
    ...
    -- 5 HR Managers
    INSERT INTO [dbo].[company_members] (user_id, company_id, is_active, joined_at, permissions)
    SELECT user_id, 1, 1, GETDATE(), '{}' FROM [dbo].[users] WHERE username LIKE 'hr[_]%';
    ...
    INSERT INTO [dbo].[company_members] (user_id, company_id, is_active, joined_at, permissions)
    SELECT user_id, 1, 1, GETDATE(), '{}' FROM [dbo].[users] WHERE username LIKE 'acc[_]%';
    ...
    -- 5 Project Managers
    INSERT INTO [dbo].[company_members] (user_id, company_id, is_active, joined_at, permissions)
    SELECT user_id, 1, 1, GETDATE(), '{}' FROM [dbo].[users] WHERE username LIKE 'pm[_]%';
    ...
    -- 5 Employees
    INSERT INTO [dbo].[company_members] (user_id, company_id, is_active, joined_at, permissions)
    SELECT user_id, 1, 1, GETDATE(), '{}' FROM [dbo].[users] WHERE username LIKE 'emp[_]%';
